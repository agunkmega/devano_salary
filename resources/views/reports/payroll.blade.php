...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 text-center">
            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">Rp {{ number_format($summary['total_bpjs'], 0, ',', '.') }}</p>
            <p class="text-xs text-gray-500 dark:text-gray-400">BPJS</p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 text-center">
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th class="text-right py-3 px-3 text-gray-500 dark:text-gray-400 font-medium">BPJS</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="py-3 px-3 text-right text-purple-600 dark:text-purple-400">Rp {{ number_format($p->bpjs_deduction, 0, ',', '.') }}</td>
