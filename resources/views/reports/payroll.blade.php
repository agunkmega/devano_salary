...
<div class="space-y-6" x-data="{ showCards: localStorage.getItem('payroll_show_cards') === '1', toggleCards() { this.showCards = !this.showCards; localStorage.setItem('payroll_show_cards', this.showCards ? '1' : '0'); } }">
    ...
    <div class="flex justify-end">
        <button type="button" @click="toggleCards()" class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            <svg x-show="showCards" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('admin.reports.payroll-excel', request()->only(['period', 'department_id', 'employee_id', 'status', 'employee_type', 'station_id', 'bank_name', 'position_grade'])) }}" class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 transition-colors">
                ...
                <a href="{{ route('admin.reports.payroll-excel-detail', request()->only(['period', 'department_id', 'employee_id', 'status', 'employee_type', 'station_id', 'bank_name', 'position_grade'])) }}" class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Resume Excel
                </a>
            </div>
